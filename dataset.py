...
class AudioAugmentation:
    ...
    def time_shift(self, waveform: torch.Tensor, shift_ratio: float = None) -> torch.Tensor:
    ...
    def volume_change(self, waveform: torch.Tensor, gain_db: float = None) -> torch.Tensor:
        """Change volume"""
        if gain_db is None:
